...
module Data.Iris.App.Internal.Resolving.RootResolverValue
...
import Data.Iris.App.Internal.Resolving.NamedResolver (runResolverMap)
import Data.Iris.App.Internal.Resolving.ResolveValue ( resolveObject )
...
import Data.Iris.App.Internal.Resolving.SchemaAPI (schemaAPI)
import Data.Iris.App.Internal.Resolving.Types
import Data.Iris.App.Internal.Resolving.Utils
  ( lookupResJSON,
  )
import Data.Mergeable.Utils (merge)
...
runRootDataResolver
  ...
  selection =
    do
      ...
      runResolver channels (resolveObject Nothing mempty root selection) ctx
...
introspection selection ctx@ResolverContext {schema} = runResolver Nothing (resolveObject Nothing mempty (schemaAPI schema) selection) ctx

mergeRoot :: MonadError GQLError m => ValidValue -> ValidValue -> m ValidValue
mergeRoot (Object tName x) (Object _ y) = Object tName <$> merge x y
