...
import Data.Mergeable.Utils.Empty (Empty)
...
instance (Hashable k, Eq k, MonadError e m, NameCollision e a) => FromList m SafeHashMap k a where
  fromList = fmap SafeHashMap . fromList
